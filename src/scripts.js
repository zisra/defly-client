var defly = (function () {
  ...
  var iz,
    ...
    kV = [
      4021759, 9587711, 16144895, 16736174, 16594229, 16747050, 9698816,
      1630751, 32823, 65468, 5625343,
    ],
    IV = [
  ...
  function ol(z, V) {
    ...
    z = l.join(" ");
    for (P = 0; P < Yl[" "].length; P++) {
      L = Yl[" "][P];
      -1 !== z.toUpperCase().indexOf(L.toUpperCase()) &&
        (z = z.replace(new RegExp(Yl[" "][P], "ig"), V));
    }
    return z;
  }
  !(function () {
  ...
  function sl(z, V, l) {
    ...
    (W.className = "no-button"),
      ...
      L.addEventListener("click", () => g(!0)),
      W.addEventListener("click", () => g(!1));
  }
  function Jl(z) {
    return (
                  ...
                  for (var D in A)
                    A[D] < V &&
                      ...
                      (l +=
                        ...
                        "</option>");
                  z ||
                    (document.getElementById("server-block").style.display =
                      "block"),
    ...
    (z.onreadystatechange = function () {
      if (4 == z.readyState && 200 == z.status)
        try {
          ...
          (c = JSON.parse(V[0])), BV ? (c = { TR: c.TR }) : delete c.TR;
          var l = !1;
          for (var D in c) c[D] && (xl(D), (l = !0));
          if (
            (l ||
              ((Sl = setTimeout(bl, 3e3)),
              BV
                ? xD(
                    new Date().toLocaleTimeString() +
      ...
      (z.onerror = function (z) {
        xD(
          ...
          ++yl < 40 && (Sl = setTimeout(bl, 3e3));
      }),
      z.open("GET", G + "/servers?m=" + hz, !0),
      z.send(null);
  }
  function Xl() {
    if (
      ...
      var D = document.getElementById("server").value
      ...
      (P.onreadystatechange = function () {
        if (4 == P.readyState && 200 == P.status)
          if (-1 != P.responseText.indexOf("LOGIN_ERROR"))
          ...
          else if (-1 != P.responseText.indexOf("ERROR"))
            z
              ? (alert(
                ...
                (document.getElementById("play-button").style.display =
                  "block"),
                (document.getElementById("play-spinner").style.display =
                  "none"),
                (N = !1))
              : ((Rl = setTimeout(Xl, 3e3)),
                xD(
                  new Date().toLocaleTimeString() +
          ...
          else if (-1 != P.responseText.indexOf("RESERVED_NICKNAME"))
            ...
            var D = P.responseText.split(" ");
            if (
              ((k = D[0]),
              (l = D[1]),
              D.length >= 3 && (hz = parseInt(D[2])),
            ...
            console.log("Server", k, "reservationKey", V), Hl();
          }
        ...
        sz ? P.send(oP) : Jz ? P.send(ZP) : P.send(null);
    } else Rl = setTimeout(Xl, 3e3);
  }
  function Hl() {
    q
  ...
  function El() {
    (N = !0),
      window.DEFLY_SERVER_URL ? ((k = window.DEFLY_SERVER_URL), Hl()) : Xl();
  }
  function _l() {
    if (!N) {
      if (Fl && !nl) {
    ...
    switch (l) {
      ...
      case 2:
        !(function (z) {
          ...
          if (
            ...
            (document.getElementById("choose-superpower").style.display =
              "none"),
            ...
            (1 != hz && 2 != hz) ||
              ...
              (XD(
                "Welcome to Team " +
                  NV[MV - 1] +
                  "." +
                  (gl.TEAMMATES.length > 0 &&
                  gl.TEAMMATES[0] &&
                  Object.keys(gl.TEAMMATES[0]).length > 0
                    ? " Press [" +
                      oL(gl.TEAMMATES[0]) +
          ...
          if (4 == hz)
            if (0 != ZV) {
              (document.getElementById("spectate-1v1-ui").style.display =
                "none"),
                (document.getElementById("gm-1v1-lobby").style.display =
                  "none"),
                document
      ...
      case 21:
        !(function (z) {
          ...
          L();
          T > V && T >= 32
            ? ((document.getElementById("hide-xp-block").style.display =
                "block"),
              (Av = new Date().getTime()))
            : V >= 32 &&
          ...
          if (RV[V]) {
            ...
            (l.hp = l.maxHP),
              3 == hz
                ...
                : l.healthBar &&
                  (p.removeChild(l.healthBar), delete l.healthBar);
          }
        })(V);
        break;
      case 23:
      ...
      case 29:
        !(function (z) {
          ...
          (nz[V] = ol(l, " ").substring(0, 12)),
            (V != HV || "?skin-editor" !== window.location.search) &&
              (Tz[V] = D);
        ...
        !(function (z) {
          ...
          for (var D = 3, v = {}, c = 0; c < _V; c++) {
            ...
            2 != hz &&
              ...
              0 == c &&
              P > 1 &&
              (AV.splice(0, 0, 5066061), NV.splice(0, 0, "Walls"), (Rv = !0));
          ...
          if (V) {
            ...
            (document.getElementById("team-choice-table").innerHTML = U),
              ...
              document.getElementById("youtube-live") &&
                (document.getElementById("youtube-live").style.display =
                  "none");
          pV &&
            !hD &&
            ((hD = setInterval(function () {
            ...
            if (1 == JV)
              showAlert("Round will start shortly", 1e3 * (xV - 1)),
                mc ||
                  ...
                  (Nc = null),
                  (document.getElementById("respawn-gm2").style.display =
                    "none"),
                  ...
                  (document.getElementById("bs-rounds-won").innerHTML =
                    bz + "/" + Xz),
                  (document.getElementById("buy-screen").style.display =
                    "block"),
                  (Sc = [!1, !1, !1, !1]),
                  Xc());
            else if (2 == JV)
      ...
      case 46:
        !(function (z) {
          ...
          (document.getElementById("gear-100-gm2").innerHTML = z.getUint8(14)),
            (document.getElementById("gear-101-gm2").innerHTML =
              z.getUint8(15)),
            (document.getElementById("gear-102-gm2").innerHTML =
              z.getUint8(16)),
            (document.getElementById("gear-103-gm2").innerHTML =
              z.getUint8(17)),
            (document.getElementById("gear-104-gm2").innerHTML =
              z.getUint8(18)),
            dD();
        })(V);
        break;
  ...
  function gD(z) {
    2 != hz &&
      ...
      Gz &&
        Gz.length > 0 &&
        (Tz[z] = Gz[Math.floor(Math.random() * Gz.length)]),
      hV &&
    ...
    if (
      ...
      (l.usernameText = g),
      Y.addChild(g),
      n && z == HV && ((l.visible = !1), (g.visible = !1)),
      fz[z])
    )
      if (F["badge-" + fz[z]]) {
  ...
  function BD(z) {
    if (z) {
      var V = az.slice();
      az = [];
      for (var l = 0; l < V.length; l++) Lc(V[l], !0);
    } else if (((az = []), jz > 0))
  ...
  function CD() {
    (document.getElementById("respawn").style.color = PV ? "white" : ""),
      ...
      (document.getElementById("choose-superpower").style.color = PV
        ? "white"
        : ""),
      (document.getElementById("upgrade-block").style.color = PV
        ? "white"
        : ""),
    ...
    for (
      z = document.getElementsByClassName("xp-bar"), V = 0;
      V < z.length;
      V++
    )
      z[V].style.backgroundColor = PV ? "rgba(255, 255, 255, 0.5)" : "";
      ...
      if (l) {
        ...
        for (g = 0; g < U.length / 2; g++) {
          ...
          if (R) Q.push(F, K);
            ...
            Q.push(Math.max(n, Math.min(f, F)), Math.max(T, Math.min($, K)));
          (d = F), (s = K);
        }
        U = Q;
      }
  ...
  function tv(z) {
    (z.alpha = 0.6), (z.isCaptured = !0);
    for (var V = 0; V < z.lines.length; V++) z.lines[V].alpha = 0.6;
  }
  function jv(z) {
    (z.alpha = 1), (z.isCaptured = !1);
  ...
  function Cv(z, V) {
    for (
      var l = z[z.length - 2], D = z[z.length - 1], v = !1, c = 0;
      c < z.length;
      c += 2
    ) {
      var P = z[c],
  ...
  function pv(z) {
    ...
    if (!V)
      return (
        console.log("Unkown current position in isDotOutOfView", HV, Kz), !0
      );
    ...
    if (RV[V]) {
      ...
      for (var c = 0; c < v.lines.length; c++) {
        ...
        delete yV[P.lineId],
          ...
          P.rightZoneId && bV[P.rightZoneId] && ov(bV[P.rightZoneId], !0);
  ...
  function dv(z, V, l) {
    var D = new PIXI.Text(z, {
      ...
      fontWeight: "bold",
      fontSize: Math.round(
        Math.min(window.innerHeight, window.innerWidth) / 30,
      ),
      fill: V || 56576,
      align: "center",
    });
  ...
  function sv(z) {
    var V = {},
      l = {},
      D = {};
    for (var v in bV) bV[v].owner == z && (V[v] = !0);
    for (var v in yV) yV[v].owner == z && (l[v] = !0);
    for (var v in RV) RV[v].owner == z && (D[v] = !0);
    for (var v in V) {
      anime({
        targets: bV[v],
        alpha: 0,
  ...
  function xv(z) {
    ...
    if (
      ...
      switch (
        ...
        case 5:
          P =
            "You were exploded by " +
            (nz[D] ? Cl(nz[D]) : " an unknown player");
      }
      if (4 == hz) {
        (Wz = []),
          (K.moving = !1),
    ...
    4 == hz &&
      ...
      (4 != l &&
        ((XV[V].visible = !1),
        (XV[V].usernameText.visible = !1),
        XV[V].badge && (XV[V].badge.visible = !1)),
      (XV[V].moving = !1),
      (XV[V].sx = 0),
      (XV[V].sy = 0)),
      !XV[V] ||
  ...
  function iv(z, V, l) {
    ...
    for (var W in yV) {
      ...
      bV[h.leftZoneId] ||
        bV[h.rightZoneId] ||
        (v(h.dot1) && v(h.dot2) && (P[h.lineId] = !0));
    }
    for (var W in P) {
    ...
    for (var W in RV) {
      if (0 == (t = RV[W]).lines.length) v(t) && (L[W] = !0);
      else
  ...
  function Ov() {
    var z = "";
    gl.SUPERPOWER.length >= 1 &&
      gl.SUPERPOWER[0] &&
      Object.keys(gl.SUPERPOWER[0]).length > 0 &&
      (z = oL(gl.SUPERPOWER[0])),
      gl.SUPERPOWER.length >= 2 &&
        gl.SUPERPOWER[1] &&
        Object.keys(gl.SUPERPOWER[1]).length > 0 &&
        (z += (z.length > 0 ? " or " : "") + oL(gl.SUPERPOWER[1]));
    var V = Fz
      ? ll[oz] + " active"
      : Zz >= 100
    ...
    if ((mc || XV[HV]) && 1 != gz)
      if (Sc[0] || Sc[1] || Sc[2] || Sc[3]) {
        ...
        (K.moving && K.moveDirection == l) ||
          ((K.moving = !0), (K.moveDirection = l), tc()),
          mc && (Kz = 0);
      } else (K.moving = !1), tc();
  }
  var Hc = !1;
  function rc(z) {
    switch (z) {
      ...
      case "TRIGHT":
        ...
        break;
      case "SHOOT":
        (K.shooting = !0), tc(), (iz.visible = !1);
        break;
      case "BUILD":
        if (!Hc && !K.shooting) {
          Hc = !0;
          var V = new Date().getTime();
          V - dc > 200 ? (Pc(), (dc = V)) : (sc = !0), 3 == hz && (sc = !0);
        }
        break;
      case "SUPERPOWER":
        Fz || ev();
  ...
  function Mc(z) {
    switch (z) {
      ...
      case "TRIGHT":
        ...
        break;
      case "SHOOT":
        if (((K.shooting = !1), tc(), (iz.visible = !!Nc), SL))
          for (var V in ((Nc = null), (iz.visible = !1), RV)) {
            var l = RV[V],
              D = cc();
          ...
          Ec < 4 &&
            showAlert(
              "Move with mouse " +
                ...
                gl.MOVEWMOUSE[0] &&
                Object.keys(gl.MOVEWMOUSE[0]).length > 0
                  ? " (shortcut: " + oL(gl.MOVEWMOUSE[0]) + ")"
                  : ""),
              2e3,
            ));
        break;
      case "TEAMMATES":
        (1 != hz && 2 != hz) || (lc ? Dc() : (Dc(), (lc = !0)));
    }
  }
  function uc(z) {
    if (
  ...
  function WP(z, V) {
    ...
    if (V) {
      ...
      z: for (var q in Uz) {
        ...
        if (_)
          for (
            c = _.getAllInRange(m.position, 0, 0), P = 0;
            P < c.length;
            P++
          ) {
  ...
  function qP(z) {
    ...
    if (e > 0 || SL) {
      lz++;
      for (var l = !1; Dz.length > 0 && Dz[0].turn <= lz; )
        YD(Dz[0].dv), (l = !0), Dz.splice(0, 1);
      if ((WP(!l && (2 != hz || 1 != JV), !0), n))
        l || (XV[HV] && !XV[HV].visible && DP(XV[HV], !0));
      else {
  ...
  function YP(z) {
                      ...
                      : 1 == W.s
                        ...
                        : 2 == W.s
                          ...
                          : ((c.y -= c.height / 2),
                            ...
                            (c.playerText.y =
                              c.y - c.height - c.playerText.height / 2)));
                } else (c.visible = !1), (c.playerText.visible = !1);
              } else
    ...
    (Fl || cV) && h.render(R, void 0, !1),
      eD && h.render(eD, void 0, !1),
    ...
    (z.onreadystatechange = function () {
      ...
      z.open(
        ...
        G +
          ...
          "&ecs=" +
          (document.getElementById("emailing-consent-checkbox").checked
            ? 1
            : 0) +
          "&ect=" +
          encodeURIComponent(
  ...
  var kP = [
      ...
      { name: "Crystals", list: [122, 123, 124, 125, 126, 127, 128] },
      {
        name: "Premium",
        list: [
          81, 82, 83, 84, 85, 86, 87, 88, 100, 101, 102, 103, 104, 105, 106,
        ],
      },
  ...
  function eP(z) {
    for (var V = AP(z), l = 0; l < kP[V].list.length; l++)
      if (kP[V].list[l] != z && !OP(kP[V].list[l])) return !1;
    return !0;
  }
  function NP(z) {
    (document.getElementById("skin-tab-" + IP).className = "skin-tab"),
      (document.getElementById("skin-tab-" + z).className =
        "skin-tab selected"),
      (IP = z),
      VL(!0);
  }
  ...
  function qL(z, V) {
    ...
    Y.setAttribute("type", "checkbox"),
      Y.setAttribute(
        "title",
        "on = rotation is not cumulative with copter hull",
      ),
  ...
  function hL() {
    ...
    mL(),
      ...
      document
        .getElementById("skin-upload-input")
  ...
  function BL() {
    if (sz || Jz) {
      ...
      (z.onreadystatechange = function () {
        if (4 == z.readyState && 200 == z.status) {
          ...
          if (
            ...
            document.getElementById("my-account-button") &&
              ((document.getElementById("my-account-button").enabled = !0),
        ...
        z.open("POST", G + "/account/myInfo?s=" + l, !0),
        z.send(null),
        document.getElementById("my-account-button") &&
          ((document.getElementById("my-account-button").enabled = !1),
          (document.getElementById("my-account-button").innerHTML =
            ml("Loading...")));
    } else XP();
  }
  ...
  function fL(z, V, l) {
    new Date().getTime() - nL < 500 ||
      ...
      (z.className = "waiting"),
      window.addEventListener("keydown", TL, !0),
  ...
  function QL(z) {
    window.removeEventListener("keydown", TL, !0),
      window.removeEventListener("mousedown", $L, !0),
      (ZL.className = ""),
      (nL = new Date().getTime()),
      void 0 !== z.keyCode && 27 == z.keyCode
        ? (ZL.innerHTML = "&nbsp;")
        : ((gl[FL][KL] = z), (ZL.innerHTML = oL(z))),
      localStorage.setItem("keyBindings", JSON.stringify(gl)),
      e > 0 && xL();
  }
  var dL = {},
    sL = {},
    JL = {};
  function xL() {
    for (var z in ((dL = {}), (sL = {}), (JL = {}), gl))
      for (var V = 0; V < gl[z].length; V++) {
        var l = gl[z][V];
        l &&
  ...
  function EL(z, V) {
    for (var l = uL(z), D = 0; D < l.length; D++)
      if (l[D].dot1 == V || l[D].dot2 == V) return !0;
    return !1;
  }
  function _L(z, V, l) {
    void 0 === l && (l = []);
  ...
  function wL() {
    ...
    (SL = !0),
      ...
      (MV = 1),
      (F["tower-kh"] = PIXI.Texture.fromImage("img/tower-kh.png")),
      (K = { shooting: !1, moving: !1, aimDirection: 0, moveDirection: 0 }),
      ...
      window.addEventListener(
        ...
        function (z) {
          if ("+" == z.key)
            ...
            var D = window.prompt(
              "Team ID? 1=grey, 2 = blue, etc up to 13",
              MV,
            );
            D &&
              ((MV = D), (iz.tint = Ll(MV)), (wz.tint = Ll(MV)), (Nc = null));
          } else if ("b" == z.key)
                  ...
                  switch (v[0]) {
                    ...
                    case "l":
                      var c,
                        ...
                        L = RV[parseInt(v[2])];
                      EL(P, L) ||
                        ((c = new DataView(new ArrayBuffer(25))).setInt32(
                          1,
                          RL++,
                        ),
    ...
    (z.onreadystatechange = function () {
      if (4 == z.readyState && 200 == z.status) {
        ...
        (D.className = "tourney-mgr"),
          ...
          (v.innerHTML = "My Team"),
          D.appendChild(v);
        for (var v, c = !1, P = 0; P < V.length - 1; P += 3)
          V[P] == iP && 1 == V[P + 2] && (c = !0);
      ...
      z.open("GET", G + "/tourney/members?s=" + (l || ""), !0),
      z.send(null);
  }
  function IL() {
    var z = "none";
    ...
    PIXI.utils.isWebGLSupported(),
      ...
      h.view.addEventListener("touchstart", fc, !0),
      h.view.addEventListener("touchmove", fc, !0),
      h.view.addEventListener("touchend", fc, !0),
      h.view.addEventListener("touchcancel", fc, !0),
      h.view.addEventListener("mousedown", Jc, !0),
      (h.view.tabindex = 1),
  ...
  function OL() {
    "undefined" != typeof Raven &&
      ...
      Raven.config(
        window.location.protocol +
          "//cac34828573e48f99770f28f2b29bd17@sentry.exodragon.io/7",
      ...
      if ("undefined" != typeof Storage) {
        if (
          ...
          localStorage.getItem("keyBindings")
            ? (gl = JSON.parse(localStorage.getItem("keyBindings")))
            : localStorage.getItem("trackPadFriendlyMode") &&
              ("1" == localStorage.getItem("trackPadFriendlyMode") &&
                ((gl.MUP = [{ code: "KeyW", keyCode: 87 }]),
                (gl.MDOWN = [{ code: "KeyS", keyCode: 83 }]),
                (gl.MLEFT = [{ code: "KeyA", keyCode: 65 }]),
                (gl.MRIGHT = [{ code: "KeyD", keyCode: 68 }]),
                (gl.SHOOT = [{ button: 0 }, { code: "ArrowUp", keyCode: 38 }]),
                (gl.TLEFT = [{ code: "ArrowLeft", keyCode: 37 }]),
                (gl.TRIGHT = [{ code: "ArrowRight", keyCode: 39 }])),
        ...
        for (var L in Wl) {
          ...
          W.className = "binding";
          var g = document.createElement("div");
          (g.className = "name"), (g.innerHTML = Wl[L]), W.appendChild(g);
    ...
    PIXI.ticker.shared.stop(),
      IL(),
      window.addEventListener("resize", kc, !0),
      window.addEventListener("mousemove", Kc, !0),
      window.addEventListener("mouseup", xc, !0),
      ...
      PIXI.loader
        ...
        .load(function (z, V) {
          ...
          (F.gridpixel = PIXI.loader.resources.gridpixel.texture),
            (F.gridpixel.baseTexture.mipmap = !1),
            ...
            (document.getElementById("homepage-loading").style.display =
              "none"),
            (document.getElementById("homepage-loaded").style.display =
              "block"),
            GL(),
            VL(),
            ((b = new PIXI.Sprite(F.shoot)).visible = !1),
            (b.tint = 0),
            (b.alpha = 0.1),
            b.anchor.set(0.5),
            ((X = new PIXI.Sprite(F.shoot)).visible = !1),
            (X.tint = 0),
            (X.alpha = 0.3),
            X.anchor.set(0.5),
            R.addChild(b),
            R.addChild(X),
            ((H = new PIXI.Sprite(F.shoot)).visible = !1),
            (H.tint = 0),
            (H.alpha = 0.1),
            H.anchor.set(0.5),
            ((r = new PIXI.Sprite(F.shoot)).visible = !1),
            (r.tint = 0),
            (r.alpha = 0.3),
            r.anchor.set(0.5),
            R.addChild(H),
            R.addChild(r),
            ((M = new PIXI.Sprite(F.build)).visible = !1),
            M.anchor.set(0.5),
            (M.alpha = 0.5),
            R.addChild(M),
            qV &&
  ...
  var eL = {
    ...
    onGoogleSignIn: function (z) {
      if (!Jz) {
        ...
        if (!V.email_verified)
          return void dl(
            "Your email for this google account is not verified",
            "",
          );
        sP(z.credential, V);
        try {
          var l,
            D = localStorage.getItem("previousGoogleCredential");
          if (D)
            try {
              l = QP(D).sub;
            } catch (z) {}
          l ||
            ((l = localStorage.getItem("wasLoggedInWithGoogle")) &&
              localStorage.removeItem("wasLoggedInWithGoogle")),
            ...
            l &&
              ...
              google.accounts.id.revoke(l, function (z) {
                console.log("User signed out from previous google account."),
                  z.successful ||
                    console.error(
                      "Google logout error for previous sub: " + z.error,
                    );
              });
        } catch (z) {}
      }
        ...
        if (4 == z.readyState && 200 == z.status) {
          for (
            var V = z.responseText.split("\n"),
              ...
              D = V[1],
              v =
                "<thead><th>GameMode<th>Start</th><th>Duration</th><th>Level reached/<br/>Rounds played</th><th>Towers destroyed</th><th>Players killed</th><th>Max Map %/<br/>Rounds win%</th><th>Max Score</th><th>Coins earnings</th><th>Kill reason</th></thead><tbody>",
              c = 0;
            c < l.length;
            c++
          ) {
            ...
            v +=
              ...
              (h = void 0),
              (q = Math.floor(g / 3600)),
              (m = Math.floor((g - 3600 * q) / 60)),
              (h = Math.floor(g - 3600 * q - 60 * m)),
              q < 10 && (q = "0" + q),
              m < 10 && (m = "0" + m),
              h < 10 && (h = "0" + h),
              q + "h" + m + "m" + h + "s") +
              ...
              L +
              "</td><td>" +
              Math.round(P.max_score) +
              "</td><td>" +
              CL(P.game_mode, P.max_score, P.dot_kills, P.player_kills) +
              "</td><td>" +
              W +
              "</td></tr>";
          }
          (v += "</tbody>"),
            (document.getElementById("my-statistics-table").innerHTML = v),
            (document.getElementById("ms-coins").innerHTML = Math.floor(D)),
            (document.getElementById("ma-coins").innerHTML = Math.floor(D)),
            (document.getElementById("ms-player-name").innerHTML =
              document.getElementById("username").value),
            (document.getElementById("my-statistics").style.display = "block"),
            (document.getElementById("my-stats-button").enabled = !0),
            (document.getElementById("my-stats-button").innerHTML =
              ml("My Statistics"));
        } else 4 == z.readyState && 200 != z.status && z.onerror(z.status);
        var g, q, m, h;
      }),
    ...
    buyPremium: function (z) {
      if (
        (sz &&
          dP(KP) &&
          dl(
            "Warning : buying premium with a school/work google account is not recommended because you will lose access to your account in the future. We recommend using a personal google account instead.",
          ),
        3 == z || 4 == z || 5 == z)
      ) {
        var V = document.getElementById("buy-premium-button");
        ...
        return (
          ...
          D.open("GET", G + "/account/xsollaToken?s=" + l, !0),
          void D.send(null)
        );
      }
      var v = iP > 0 ? iP : encodeURIComponent(KP);
      if (1 == z)
        var c = window.open(
          "https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=serial@defly.io&item_name=Premium%20Account%20for%20Defly.io%20%28inside%20EU%29&item_number=" +
            v +
            "&currency_code=EUR&country=GB&lc=US&no_shipping=1&amount=5",
        );
      else
        c = window.open(
          "https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=serial@defly.io&item_name=Premium%20Account%20for%20Defly.io%20%28outside%20EU%29&item_number=" +
            v +
    ...
    updateReservedNickname: function () {
      ...
      (D.onreadystatechange = function () {
        ...
        D.open(
          "POST",
          G + "/account/updateReserved?s=" + l + "&n=" + encodeURIComponent(z),
          !0,
        ),
        D.send(null);
    },
    updateDiscordID: function () {
      ...
      let D = Math.min(400, window.innerWidth),
        ...
        L = window.open(
          "https://discord.com/api/oauth2/authorize?client_id=473845898728964096&response_type=token&redirect_uri=" +
            encodeURIComponent(window.location.origin) +
            "%2FdiscordOAuth.html&scope=identify+email",
          "_blank",
              ...
              if ((L.close(), D)) {
                ...
                (v.onreadystatechange = function () {
                  if (4 == v.readyState && 200 == v.status) {
                    ...
                    if ("ERROR" == l[0]) alert(l[1]);
                    else {
                      var D = l[1],
                        c = l[2];
                      document.getElementById("discord-id").value = c
                        ? "@" + c
                        : D;
                    }
                  } else
                  ...
                  v.send(null);
              } else (z.disabled = !1), (z.innerHTML = V);
            }
          } catch (z) {}
        }, 100);
    },
        ...
        $.getScript("tablefilter/tablefilter.js", function () {
          new TableFilter(
            ...
            { base_path: "./tablefilter/" },
            {
              ...
              status_bar: !0,
              rows_counter: { text: "Games: " },
              alternate_rows: !0,
              btn_reset: !0,
              auto_filter: { delay: 1e3 },
              themes: [{ name: "default" }],
            },
          ).init(),
            $("#ms-sums").show();
