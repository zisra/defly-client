        ...
        if (!l) {
          ...
          xD(
            new Date().toLocaleTimeString() +
              (() => {
                if (BV) " - Please wait, tournament is opening... ";
                else " - Downloaded server list was empty";
              })(),
            (() => {
              if (BV) "";
              else "error";
    ...
    document.getElementById("gamemode-" + z) &&
      (() => {
        if (hz == z)
          ...
          document.getElementById("gamemode-" + z).classList.remove("selected");
      })();
}
var wl = false;
function Gl() {
    ...
    if (
      ...
      if (
        ...
        return (() => {
          wl = false;
          "undefined" != typeof gtag &&
            gtag("event", "BlockedAdInPlayVideo", {
              event_category: "Ads",
            });
          false;
        })();
    ...
    case 1:
      {
        ...
        Al++;
        (() => {
          if ((0 != hz && 1 != hz && 3 != hz) || 1 != e)
            (() => {
              if (1 == hz && -1 != yv)
                setTimeout(() => {
                  bv(yv);
                }, 250);
              else (O = true), q.close(), (Rl = setTimeout(Xl, 250));
            })();
          else setTimeout(Wc, 250);
        })();
        Al >= 20 &&
          ...
          if (0 != ZV) {
            ...
            const z = Date.now(),
              V = setInterval(() => {
                ...
                } else O.innerText = Math.ceil((5e3 - l) / 1e3);
              }, 100);
          } else {
            n = XV[HV].position;
            XV[HV].visible = false;
    ...
    case 4:
      !((z) => {
        ...
        if (lz - (Vz = V) >= 4) {
          ...
          {
            0;
            lz -= Math.max(1, Math.ceil((lz - Vz) / 10));
            uv(-l);
          }
        }
        if (Vz - lz >= 4) {
                ...
                if (V < 20)
                  (h.alpha = 0),
                    anime({
                      targets: h,
                      alpha: (() => {
                        if (3 == hz && q.isCaptured) 0.6;
                        else 1;
                      })(),
                      duration: 250,
                      easing: "linear",
                    });
                else 3 == hz && q.isCaptured && (h.alpha = 0.6);
              })();
            }
          }
        }
    ...
    case 11:
      !((z) => {
        ...
        for (
          ...
          if (!Fl || g < 5) {
            var m = (() => {
              if (1 == hz || 2 == hz) Ll(uV[P[g].id]);
              else Pl(P[g].id);
            })();
            W += `<div class="lb-item${q ? " is-self" : ""}"><span class="color" style="background-color: ${HP(m)}"></span><span class="rank">${g + 1}.</span><span class="player-name${(() => {
              if (g + 1 >= 10) " l";
              else "";
            })()}">${Cl(nz[P[g].id])}</span><span class="points">${P[g].points}</span></div>`;
          }
        }
        if (
          (() => {
      ...
      !((z) => {
        ...
        }
        {
          ...
          (() => {
            ...
            else document.getElementById("upgrade-points").innerHTML = jz;
          })();
        }
        jz > 0 &&
          0 == l &&
      ...
      !((z) => {
        ...
        if (RV[V]) {
          var v = RV[V];
          {
            ...
            v.hp -= 1;
            (() => {
              if (3 == hz) v.texture = F["dot" + v.hp + "-" + v.maxHP];
              else
                v.healthBar.outer.width = (v.healthBar.width * v.hp) / v.maxHP;
            })();
          }
        }
      })(V);
      ...
      !((z) => {
        ...
        if (RV[V]) {
          ...
          }
          {
            l.hp = l.maxHP;
            (() => {
              if (3 == hz) l.texture = F["dot" + l.hp + "-" + l.maxHP];
              else
    ...
    case 27:
      !((z) => {
          ...
          v = new PIXI.Sprite(F.portal1);
        {
          ...
          v.anchor.set(0.5);
          (() => {
            if (XV[V]) v.position.set(XV[V].position.x, XV[V].position.y);
            else v.position.set(-1e4, -1e4);
          })();
        }
        Z.addChildAt(v, 0);
        ...
        var P = (() => {
            if (XV[V]) XV[V].scale.x;
            else 1;
          })(),
          L = (() => {
            if (XV[V]) XV[V].scale.y;
            else 1;
          })();
        anime({
          targets: (() => {
    ...
    case 34:
      !((z) => {
        ...
        document.getElementById(
          "respawn-earned-coins" +
            (() => {
              if (2 == hz) "-gm2";
              else "";
            })(),
        ).innerHTML = (() => {
          if (sz || Jz || D < 1) Math.floor(D);
          else
        ...
        for (var t in v) {
          var j = AV[t - 1];
          {
            ...
            U +=
              "<td" +
              (() => {
                if (V) ' style="background-color: ' + HP(j) + ';"';
                else "";
              })() +
              ">" +
              colorNamesNew[t - 1] +
    ...
    case 40:
      !((z) => {
        if (4 == hz) {
          ...
          {
            document.getElementById("gm-1v1-result-title").innerHTML = (() => {
              if (D) "Match cancelled (opponent disconnected)";
              else
                (() => {
                  if (0 == V) "No winner, rematch?";
                  else
                    (() => {
                      if (V == HV) "You defeated " + Cl(nz[l]);
                      else "You lost to " + Cl(nz[V]);
                    })();
                })();
            })();
            document.getElementById("respawn-earned-coins-gm4").innerHTML =
              (() => {
                if (D) 0;
                else
                  (() => {
              ...
              (!(() => {
                ...
                for (
                  ...
                  (P.size = L),
                    ...
                    (P.height = L / 2),
                    (P.x = (() => {
                      if (c < 150) 0.25 * window.innerWidth;
                      else 0.75 * window.innerWidth;
                    })()),
      ...
      !((z) => {
        ...
        if (4 == hz && 0 == V && l.startsWith("1v1RESULT/")) {
          ...
          return void XD(
            c
              ? (() => {
                  if (P == HV || L == HV) "Your match was cancelled";
                  else
                    "Match between " +
                      Cl(nz[P]) +
                      " and " +
    ...
    case 45:
      !((z) => {
        ...
        if (0 == V) {
          ...
          (() => {
            if (1 == V) l.progress.visible = false;
            else
              2 == V &&
                (() => {
                  v.animInterval && clearInterval(v.animInterval);
    ...
    case 47:
      !((z) => {
        ...
        document.getElementById("respawn-button").innerHTML = (() => {
          if (V > 0) "Respawn<div>at level " + V + "</div>";
          else "Respawn";
        })();
      })(V);
      break;
      ...
      !((z) => {
        ...
        for (var l = 2, D = "", v = 0; v < V; v++) {
            ...
            P = Nl(z, l + 1);
          {
            ...
            D += '<div onclick="defly.voteForMap(' + v + ');">' + P + "</div>";
          }
        }
        {
      ...
      !((z) => {
        ...
        for (
          ...
          isFinite(D) &&
            ...
            (() => {
              AV[l] = IV[D - 1];
              zl || (colorNamesNew[l] = colorNames[D - 1]);
            })();
        }
      })(V);
      break;
    case 58:
      !((z) => {
        ...
        if (
          ...
          var W = (() => {
            if (XV[Kz].filters && XV[Kz].filters.length > 0) XV[Kz].filters[0];
            else null;
          })();
          {
            W ||
    ...
    case 64:
      !((z) => {
        ...
        for (var l = 0; l < V.length; l++) {
          var D = parseInt(V[l]);
          if (DD[D]) Gz.push(D);
          else console.error("Skin id does not exists", D);
        }
      })(V);
      break;
    case 98:
  ...
  for (var g = 0; g < v.rotors.length; g++) {
    ...
    if (F[q.img] && q.visibility != W) {
      ...
      } else L = PD(F[q.img], 256);
      {
        ...
        (() => {
          if (void 0 !== q.layer) c.insertBefore(m, c.childNodes[q.layer]);
...
function gD(z) {
  ...
  for (var c = 0; c < V.rotors.length; c++) {
      ...
      L = new PIXI.Sprite(F[P.img]);
    {
      ...
      L.y = P.y * kz * V.size;
      (() => {
        if (void 0 !== P.layer && P.layer <= l.children.length)
      ...
      l.rotors.push({
        ...
        speed: P.speed,
        visibility: (() => {
          if (void 0 !== P.visibility) P.visibility;
          else 0;
        })(),
...
function jD() {
  {
    tD = (() => {
      if (1 == iV) ((3 * Math.sqrt(3)) / 2) * (Oz / 2) ** 2;
      else
        (() => {
          if (2 == iV) (((Math.PI * Oz) / 2) * ez) / 2;
          else Oz * ez;
        })();
    })();
    mD = [
...
function CD() {
  {
    document.getElementById("respawn").style.color = (() => {
      if (PV) "white";
      else "";
    })();
    document.getElementById("respawn").style.backgroundColor = (() => {
      if (PV) "rgba(255, 255, 255, 0.2)";
      else "";
    })();
    document.getElementById("respawn-gm2").style.color = (() => {
      if (PV) "white";
      else "";
    })();
    document.getElementById("respawn-gm2").style.backgroundColor = (() => {
      if (PV) "rgba(255, 255, 255, 0.2)";
      else "";
    })();
    ...
    document.getElementById("chat-history").style.color = (() => {
      if (PV) "white";
      else "";
    })();
    document.getElementById("chat-history-full").style.color = (() => {
      if (PV) "white";
      else "";
    })();
    ...
    document.getElementById("choose-superpower").style.color = (() => {
      if (PV) "white";
      else "";
    })();
    document.getElementById("upgrade-block").style.color = (() => {
      if (PV) "white";
      else "";
    })();
  ...
  for (
    ...
    z[V].style.backgroundColor = (() => {
      if (PV) "rgba(84, 84, 84, 0.7)";
      else "";
    })();
  for (
    (() => {
      z = document.getElementsByClassName("score-bar");
      V = 0;
    })();
    V < z.length;
    V++
    ...
    z[V].style.backgroundColor = (() => {
      if (PV) "rgba(255, 255, 255, 0.5)";
      else "";
    })();
  for (
    (() => {
      z = document.getElementsByClassName("xp-bar");
      V = 0;
    })();
    V < z.length;
    V++
  ...
  if (PV) document.body.classList.add("dark-theme");
  ...
  for (var D = {}, v = 0; v < l; v++) {
      ...
      m = z.getUint8(V + 24);
    {
      ...
      (() => {
        ...
        else (XV[c].sx = W), (XV[c].sy = g), (XV[c].shield.visible = 3 == m);
      })();
      pD(P, L, XV[c]);
    }
  }
...
function showAlert(z, V, l) {
  var D = document.getElementById("user-info");
  {
    ...
    KD = setTimeout(() => {
      ...
      nD = setInterval(() => {
        var V = new Date().getTime() - z;
        if (V > 500) clearInterval(nD), window.document.body.removeChild(D);
        else D.style.opacity = 1 - V / 500;
      }, 20);
    }, V);
  }
}
...
function dD(z) {
  ...
  V &&
    anime({
      ...
      complete: () => {
        {
          window.document.body.removeChild(V);
          "function" == typeof z && z();
        }
      },
    });
...
function HD(z) {
  ...
  {
    V.setUint8(0, 10);
    V.setUint8(1, z.length);
  }
  for (var l = 0; l < z.length; l++) {
    var D = z.charCodeAt(l);
    {
      V.setUint8(2 + 2 * l + 1, 255 & D);
      V.setUint8(2 + 2 * l + 0, D >>> 8);
    }
  }
  q.send(V.buffer);
}
...
function OD() {
  ...
  0 != kD &&
    ((z, V, l) => {
      z.sort((z, D) =>
        (() => {
          if ("string" == typeof EV[z][V])
            EV[z][V].localeCompare(EV[D][V]) *
              (() => {
                if (l) 1;
                else -1;
              })();
...
function Wv(z, V, l) {
  return (() => {
    if (3 == hz && 0 != l) "dot" + V + "-" + l;
      ...
      (() => {
        if (SV || !aV || (1 != hz && 2 != hz) || z == MV)
          (() => {
            if (!SV && aV && 0 == hz && z != HV) "dot1-enemy";
            else "dot1";
          })();
        else "dot1-enemy";
      })();
    ...
    for (W = 0; W < c; W++) {
      ...
      if (
        (() => {
          ...
          (() => {
            if (t) j.leftZoneId = l;
            else j.rightZoneId = l;
          })();
          1 == W;
        })()
      ) {
        var a;
        if (j.dot1 == g.dot1 || j.dot1 == g.dot2) a = j.dot1;
        else (j.dot2 != g.dot1 && j.dot2 != g.dot2) || (a = j.dot2);
        var B = (() => {
          if (g.dot1 == a) g.dot2;
          else g.dot1;
        })();
...
function Uv(z, V, l, D) {
  ...
  if (bV[v]) V += 5 * L;
    ...
    for (g = 0; g < L; g++) {
      ...
      {
        V += 5;
        yV[t] || console.error("new zone: line not found: " + t);
      }
      var a = yV[t];
      if (
        (() => {
          ...
          (() => {
            if (j) a.leftZoneId = v;
            else a.rightZoneId = v;
          })();
          1 == g;
        })()
      ) {
        var B;
        if (a.dot1 == q.dot1 || a.dot1 == q.dot2) B = a.dot1;
        else (a.dot2 != q.dot1 && a.dot2 != q.dot2) || (B = a.dot2);
        var p = (() => {
          if (q.dot1 == B) q.dot2;
          else q.dot1;
        })();
...
function pv(z) {
  ...
  if (!V)
    return (() => {
      console.log("Unkown current position in isDotOutOfView", HV, Kz);
      true;
    })();
...
function Tv(z) {
  ...
  if (RV[V]) {
    ...
    for (var c = 0; c < v.lines.length; c++) {
      ...
      {
        L.lines.splice(L.lines.indexOf(P), 1);
        Fv(L);
      }
    }
              ...
              WV ||
                XD(
                  "<span>" +
                    ...
                    (() => {
                      if (c == HV) "<span> (you get the kill)</span>";
                      else "";
                    })(),
                  (() => {
                    if (PV) "info-dark";
...
function Hv(z, V, l, D, v, c, P, L) {
  ...
  for (
    ...
    var m = (() => {
        if (W) W + Math.random() * Math.PI - Math.PI / 2;
        else Math.random() * Math.PI * 2;
      })(),
      h = Math.random() * kz * c,
...
function Nv(z) {
  return (() => {
    if (tz) Math.round(z / nV) * nV + (nV / 2) * 0;
    else z;
  })();
}
function zc(z) {
...
anime.easings.flashbangCurve = (z) =>
  (() => {
    if (z < 0.5) anime.easings.easeInQuad(2 * z) / 2;
    else anime.easings.easeInQuad(2 * (0.5 - (z - 0.5))) + 0.5;
  })();
var Vc = [],
  lc = false;
function Dc() {
  for (var z = 0; z < Vc.length; z++) {
    p.removeChild(Vc[z].playerText);
    p.removeChild(Vc[z]);
  }
  {
    Vc = [];
...
function cc(z) {
  ...
  var l = new PIXI.Point(
    (() => {
      ...
      V * Math.cos(K.aimDirection),
    (() => {
      if (z) z.y;
      else XV[HV].y;
    })() +
      V * Math.sin(K.aimDirection),
  );
  return (() => {
    aD(l);
    l;
...
function gc() {
  {
    ...
    showAlert(
      ...
      })() + " anywhere to spectate next player",
      1e4,
    );
  }
}
        ...
        if ("touchend" === z.type || "touchcancel" === z.type)
              ...
              (() => {
                jc && jc.identifier == v.identifier
                  ? ((K.moving = false),
                    ...
                    (jc = null))
                  : (() => {
                      if (Cc && Cc.identifier == v.identifier)
                        (K.shooting = false),
                          tc(),
                          (H.visible = false),
                          (r.visible = false),
          ...
          for (D = 0; D < z.changedTouches.length; D++) {
            ...
            if (
              ...
              Yc = null;
            } else if (v.clientX <= window.innerWidth / 2) {
              jc = {
                clientX: v.clientX,
                clientY: v.clientY,
                identifier: v.identifier,
            ...
            if (jc && v.identifier == jc.identifier && XV[HV]) {
              if (
                ...
                );
                {
                  ...
                  K.moving = true;
                  (() => {
                    if ((V = new Date().getTime()) - Zc > 20) tc(), (Zc = V);
                    else Fc = true;
                  })();
                  W >= 0.4 * l &&
    ...
    if (!(l && document.activeElement == l)) {
      if (V && dL[z.code]) rc(dL[z.code]);
        ...
        if (
          ...
          (() => {
            if (0 == D.style.opacity) D.style.opacity = 1;
            else 0.5 == D.style.opacity && (D.style.opacity = 0);
          })();
...
function kc() {
  {
    h.resize(window.innerWidth, window.innerHeight);
    lV = Nz;
    DV = zV;
  }
  ...
  if (
    ...
    if (l) {
      var D = z.position.cpy().sub(z.lastPosition),
        ...
        P = z.position.cpy();
      {
        z.position.set(l.x, l.y);
        z.position.add(c.nor().scl(l.dst(P)));
      }
  ...
  if (V) {
    ...
    for (var q in Uz) {
      if (!((m = Uz[q]).initialTurn >= lz))
        if (E)
          for (
            (() => {
              c = E.getAllInRange(m.position, 0, 0);
              P = 0;
            })();
            P < c.length;
            P++
    ...
    z: for (var q in Uz) {
      ...
      if (_)
        for (
          (() => {
            c = _.getAllInRange(m.position, 0, 0);
            P = 0;
          })();
          P < c.length;
          P++
...
function YP(z) {
        ...
        (() => {
          x.noRotation
            ...
            : 0 != x.speed &&
              ...
              (() => {
                if (x.fixedRotation) x.sprite.rotation = x.sprite.baseRotation;
                else x.sprite.rotation = x.sprite.baseRotation - s.rotation;
              })());
          1 == x.visibility;
        })()
      ) {
  ...
  }
  {
    ...
    (() => {
      if (e > 0 && !n && new Date().getTime() - oD > 1e3)
        (tP = true),
...
function SP(z) {
  if (
    (() => {
      console.log("Facebook login status", z);
      !sz;
    })()
  )
  ...
  var z = new XMLHttpRequest();
  {
    z.onreadystatechange = () => {
      if (4 == z.readyState && 200 == z.status)
        if (-1 != z.responseText.indexOf("ERROR"))
          ...
          F && VL(true),
            (() => {
              if (window.location.search.startsWith("?my-account")) BL();
              else
                (() => {
                  if ("?tourney-mgr" == window.location.search) kL();
                  else
                        ...
                        if (
                          ...
                          (V.onreadystatechange = () => {
                            if (4 == V.readyState && 200 == V.status)
                              (() => {
                                if (-1 != V.responseText.indexOf("ERROR"))
    ...
    z.open(
      ...
      G +
        ...
        "&app=" +
        (() => {
          if (document.getElementById("privacy-policy-checkbox").checked) 1;
          else 0;
        })() +
        "&ecs=" +
        (() => {
          if (document.getElementById("emailing-consent-checkbox").checked) 1;
          else 0;
        })() +
        "&ect=" +
        encodeURIComponent(
...
window.onGoogleLibraryLoad = () => {
  try {
    ...
    if (z) {
      ...
      if (V && Date.now() / 1e3 < V.exp - 60) sP(z, V);
      else
...
var kP = [
    ...
    {
      name: "Elite",
      list: [71, 79, 96, 97, 98, 99, 136, 137, 138, 139],
    },
    {
      name: "Creeper",
      list: [72, 73, 74, 75, 76, 77, 78],
    },
    {
      name: "Paper",
      list: [130, 131, 132, 133, 134, 135],
    },
    {
      name: "Star Wars",
      list: [114, 115, 116, 117, 118, 119, 120, 121],
    },
    {
      name: "Other",
      list: [129],
...
function OP(z) {
  return (
    1 == z ||
    (() => {
      if (2 == z) MP.skinFacebookLiked;
      else
        3 == z ||
          (() => {
            if (4 == z) MP.skinTwitterFollow;
            else
              (() => {
                if (5 == z) MP.skinTwitterTweet;
                else
                  (() => {
                    if (6 == z) MP.skinYoutubeSubscribe;
                    else
                      (() => {
                        if (7 == z) sz || Jz;
                        else
                          (() => {
                            if (8 == z) MP.skinDiscordJoin;
                            else -1 !== uP.indexOf(z);
                          })();
                      })();
                  })();
  ...
  } catch (err) {}
  {
    ...
    vL = setInterval(() => {
      for (var l = XV[-2], D = 0; D < l.rotors.length; D++) {
        var v = l.rotors[D];
        if (v.noRotation) v.sprite.rotation = -l.rotation;
        else
          0 != v.speed &&
            ((v.sprite.baseRotation -= (v.speed * (1e3 / 60)) / 1e3),
            (() => {
              if (v.fixedRotation) v.sprite.rotation = v.sprite.baseRotation;
              else v.sprite.rotation = v.sprite.baseRotation - l.rotation;
            })());
        var c = 0 != cL.stance;
        if (1 == v.visibility) v.sprite.visible = c;
        else 2 == v.visibility && (v.sprite.visible = !c);
      }
      z.render(V);
    }, 1e3 / 60);
  }
      ...
      z.onreadystatechange = () => {
        if (4 == z.readyState && 200 == z.status) {
          ...
          (_P = parseInt(V[0]) > 0),
            ...
            (document.getElementById("account-premium").style.display = (() => {
              if (_P) "block";
              else "none";
            })()),
            (document.getElementById("account-standard").style.display =
              (() => {
                if (_P) "none";
                else "block";
              })()),
...
function oL(z) {
  return (() => {
    if (z.code) z.code.replace(/^Key/, "");
    else
      (() => {
        if (z.keyCode)
          (() => {
            if (YL[z.keyCode]) YL[z.keyCode];
            else z.keyCode;
          })();
        else
          (() => {
            if (void 0 !== z.button)
              (() => {
                if (0 == z.button) "Left Click";
                else
                  (() => {
                    if (1 == z.button) "Middle Click";
                    else
                      (() => {
                        if (2 == z.button) "Right Click";
                        else "Mouse button " + z.button;
                      })();
                  })();
              })();
            else "&nbsp;";
...
function QL(z) {
  {
    ...
    nL = new Date().getTime();
    (() => {
      if (void 0 !== z.keyCode && 27 == z.keyCode) ZL.innerHTML = "&nbsp;";
      else (customKeyboardCommands[FL][KL] = z), (ZL.innerHTML = oL(z));
    })();
  ...
  function v(z, V, l) {
    ...
    for (var D = 0; D < 16; D++) {
      ...
      });
      {
        ...
        v.position.x = (() => {
          if (l >= 2) (D % 4) * 3;
          else (Math.floor(D / 4) % 4) * 3;
        })();
        v.position.y = (() => {
          if (l >= 2) (Math.floor(D / 4) % 4) * 3;
          else (D % 4) * 3;
        })();
...
function rL(z, V, l) {
  ...
  return (() => {
    if (v < 0) z;
      ...
      (() => {
        if (v > 1) V;
        else new PIXI.Point(z.x + v * (V.x - z.x), z.y + v * (V.y - z.y));
      })();
  })();
}
function vP(z, V, l) {
...
function ML(z, V) {
  return (() => {
    if (z.dot1 == V) z.rotation;
    else
      (() => {
        if (z.rotation > 0) z.rotation - Math.PI;
        else z.rotation + Math.PI;
      })();
  })();
}
function uL(z) {
        ...
        for (var l in bV) {
          ...
          for (V = 0; V < D.length; V++) {
            ...
            (z +=
              " " +
              (() => {
                if (c.dot1 == v.dot1 || c.dot1 == v.dot2) c.dot1;
                else c.dot2;
              })().dotId),
              (v = c);
          }
              ...
              W.addEventListener(
                ...
                ((z) => () => {
                  if (
                    ...
                    var V = new XMLHttpRequest();
                    (V.onreadystatechange = () => {
                      if (4 == V.readyState && 200 == V.status) kL();
                      else
                        4 == V.readyState &&
                          200 != V.status &&
                          V.onerror(V.status);
...
function IL() {
  ...
  h &&
    h.view &&
    (() => {
      document.body.removeChild(h.view);
      z = h.view.style.display;
    })();
  {
  ...
  try {
    if ("undefined" != typeof Storage) {
            ...
            if (localStorage.getItem("keyBindings"))
              ...
              localStorage.getItem("trackPadFriendlyMode") &&
                ("1" == localStorage.getItem("trackPadFriendlyMode") &&
                  ((customKeyboardCommands.MUP = [
                    {
                      code: "KeyW",
                      keyCode: 87,
                    },
                  ]),
                  (customKeyboardCommands.MDOWN = [
                    {
                      code: "KeyS",
                      keyCode: 83,
                    },
                  ]),
                  (customKeyboardCommands.MLEFT = [
                    {
                      code: "KeyA",
                      keyCode: 65,
                    },
                  ]),
                  (customKeyboardCommands.MRIGHT = [
                    {
                      code: "KeyD",
                      keyCode: 68,
                    },
      ...
      for (var L in keyboardCommands) {
        ...
        {
          m.innerHTML = (() => {
            if (f.length >= 1 && f[0] && Object.keys(f[0]).length > 0) oL(f[0]);
            else "&nbsp;";
          })();
          n.innerHTML = (() => {
            if (f.length >= 2 && f[1] && Object.keys(f[1]).length > 0) oL(f[1]);
            else "&nbsp;";
          })();
          m.addEventListener(
            "click",
...
var defly = (() => {
  return {
    ...
    spectate: () => {
      ...
      else document.getElementById("respawn").style.display = "none";
    },
    upgrade: Lc,
    selectSuperpower: (z) => {
      document.getElementById("choose-superpower").style.display = "none";
